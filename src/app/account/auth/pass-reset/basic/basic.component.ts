...
export class BasicComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.otp.requestOTP(this.f['email'].value).subscribe({
      next: (res: Response<any>) => {
        this.otp.email = this.f['email'].value
        this.router.navigate(['auth', 'pass-reset', 'otp'])
        this.loading = false
        Dialogs.success('We sent a reset code to the email you entered', this.translate)
