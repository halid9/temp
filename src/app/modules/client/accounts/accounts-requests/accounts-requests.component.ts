...
@Component({
  selector: 'accounts-requests',
  templateUrl: 'accounts-requests.component.html',
  styleUrls: ['accounts-requests.component.scss'],
  providers: [ContentService, DecimalPipe]
})
export class AccountsRequestsComponent {
  sortClass = ''
  sortCol = ''
  // bread crumb items
