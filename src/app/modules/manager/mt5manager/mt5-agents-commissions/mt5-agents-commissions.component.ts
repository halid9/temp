...
@Component({
  selector: 'app-mt5-agents-commissions',
  templateUrl: './mt5-agents-commissions.component.html',
  styleUrls: ['./mt5-agents-commissions.component.scss']
})
export class Mt5AgentsCommissionsComponent {
  ...
  constructor(private dataService: DataService, private managerService: Mt5ManagerService) { }
