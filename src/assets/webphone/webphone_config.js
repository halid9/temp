...
webphone_api.parameters = {
    ...
    enginedefpriority_java: 0,
    enginedefpriority_webrtc: 1,
    enginedefpriority_flash: 0,
    enginedefpriority_ns: 0,
    enginedefpriority_app: 0,
    enginedefpriority_p2p: 0,
    enginedefpriority_callback: 0,

    // enginedefpriority_nativedial: 0,
